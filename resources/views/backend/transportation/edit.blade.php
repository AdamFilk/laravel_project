<x-backend>
  ...
  @endphp
  <form action="{{route('backside.transportation.update',$id)}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="col-xl-8">
            ...
            <div class="row">      
             <div style="padding-left: 40px;">
              ...
              <input name="type" class="form-control" type="text" style="display: inline-block;" id="type_id" name="type" value="{{$type}}">  
        ...
        <div class="col-sm-10">
          <select class="form-control" name="locationid">
            ...
            <option value="{{$location->id}}" 
              @if($transportation->locationid == $location->id)
               {{'selected'}} 
               @endif >
              {{$location->name}}
            </option>
    ...
    <button class="btn-success" style="border: none;">Update</button>
  </div>
</div>
</div>
</div>
