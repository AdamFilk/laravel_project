<x-backend>   
  <form action="{{route('backside.originalpackage.store')}}" method="POST" enctype="multipart/form-data">
    @csrf 
            ...
            <div class="card">
              <div class="card-header border-0">
                <div class="row align-items-center">
                  <div class="col">
                    <h3 class="mb-0">New Original Packages</h3>
                  </div>
                  <div class="col text-right tableIcon">
                   <a href="{{route('backside.originalpackage.index')}}" class="plusBtn" style="color: black;" >
